...
type Service interface {
	...
	AddPersonNode(ctx context.Context, personNode *Person, labels []string) error
...
var GraphDBService Service

// InitGraphDbService 是 graphDB 服务的构造函数。
func InitGraphDbService() (Service, error) {
	if GraphDBService != nil {
		return GraphDBService, nil
	}
	...
	GraphDBService = &serviceImpl{driver: driver}
	return GraphDBService, nil
}
